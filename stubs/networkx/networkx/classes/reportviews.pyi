...
_DataMode = TypeVar("_DataMode", Literal[True], Literal[False], str, default=Literal[True])
_D = TypeVar("_D")
_U = TypeVar("_U")
...
class NodeView(Mapping[_Node, _NodeData], AbstractSet[_Node], Generic[_Node, _NodeData, _EdgeData]):
    ...
    @overload
    def __call__(self, data: Literal[True], default=None) -> NodeDataView[_Node, _NodeData, _EdgeData]: ...
    @overload
    def __call__(self, data: str, default=None) -> NodeDataView[_Node, _NodeData, _EdgeData, str]: ...

    @overload
    def data(self, data: Literal[False], default=None) -> Self: ...
    @overload
    def data(self, data: Literal[True] = True, default=None) -> NodeDataView[_Node, _NodeData, _EdgeData]: ...
    @overload
    def data(self, data: str, default=None) -> NodeDataView[_Node, _NodeData, _EdgeData, str]: ...

class NodeDataView(AbstractSet[_Node], Generic[_Node, _NodeData, _EdgeData, _DataMode]):
    __slots__ = ("_nodes", "_data", "_default")
    def __init__(self, nodedict: _NodeData, data: _DataMode = False, default=None) -> None: ...
    def __len__(self) -> int: ...

    @overload
    def __iter__(self: NodeDataView[_Node, _NodeData, _EdgeData, Literal[True]]) -> Iterator[tuple[_Node, _NodeData]]: ...
    @overload
    def __iter__(self: NodeDataView[_Node, _NodeData, _EdgeData, Literal[False]]) -> Iterator[tuple[_Node]]: ...
    @overload
    def __iter__(self: NodeDataView[_Node, _NodeData, _EdgeData, str]) -> Iterator[tuple[_Node, Any]]: ...  # type: ignore[override]

    def __contains__(self, n: object) -> bool: ...

    @overload
    def __getitem__(self: NodeDataView[_Node, _NodeData, _EdgeData, str], n: _Node) -> Any: ...
    @overload
    def __getitem__(self: NodeDataView[_Node, _NodeData, _EdgeData], n: _Node) -> _NodeData: ...
